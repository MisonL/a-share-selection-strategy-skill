...
- `new_count=40`
- `unique=true`
- 与 `docs/reviews/REAL-SCENARIO-GATES-2026-05-30.md`、`docs/reviews/P1-PORTFOLIO-CAPACITY-SZ-MAINBOARD-2026-06-01.md`、`docs/reviews/P1-PORTFOLIO-CAPACITY-CYB-2026-06-01.md` 中 6 位 symbol，以及已记录问题符号 `600438`、`688981` 的交集为 `[]`
