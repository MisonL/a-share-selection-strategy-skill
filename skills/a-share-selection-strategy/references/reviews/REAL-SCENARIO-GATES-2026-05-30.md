...
历史 stdout 和字段名按当时运行结果原样保留。若与当前 README、SKILL 或 `skills/a-share-selection-strategy/references/output-templates.md` 的优先字段不同，当前报告应优先使用新文档中的中性字段，历史报告只作为当时证据。
