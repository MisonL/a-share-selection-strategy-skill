...
.empty{color:var(--muted)}
	.watchlist-dashboard{display:grid;grid-template-columns:minmax(0,1.26fr) minmax(300px,.76fr) minmax(360px,1.06fr);gap:12px;align-items:stretch}
		.watchlist-preview-pane,.operator-checklist,.candidate-entry-card{min-width:0;border:1px solid var(--line);border-radius:8px;background:#fff;padding:11px}
.candidate-cards[data-preview-table]{display:block;min-width:0;max-width:100%;overflow-x:auto}
.candidate-cards[data-preview-table] table{min-width:560px;table-layout:fixed;white-space:normal}
...
.candidate-toolbar input,.candidate-toolbar select,.candidate-toolbar button{width:100%;height:36px;border:1px solid var(--line);border-radius:7px;background:#fff;color:var(--ink);font:inherit;padding:6px 10px}
...
.master-table table{min-width:980px;white-space:normal}
...
@media(max-width:1500px){.watchlist-dashboard{grid-template-columns:minmax(0,1fr) minmax(280px,.72fr)}.candidate-entry-card{grid-column:1/-1}.candidate-open-banner{min-height:150px}.report-overview-grid{grid-template-columns:minmax(0,1fr) minmax(420px,.9fr)}.selection-flow{grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.flow-arrow{display:none}}
@media(max-width:1280px){.hero-title-row,.report-overview-grid,.watchlist-dashboard,.final-notice-grid{grid-template-columns:1fr}.selection-flow{grid-template-columns:repeat(4,1fr);gap:12px}.flow-arrow{display:none}.candidate-open-banner{min-height:150px}.master-detail-grid{grid-template-columns:1fr}.detail-body{grid-template-columns:1fr}.detail-main{border-right:0;border-bottom:1px solid var(--line)}.hero-fact-card{max-width:none}.master-table{max-height:52vh}}
@media(max-width:1100px){.candidate-toolbar{grid-template-columns:repeat(2,minmax(0,1fr))}.candidate-toolbar label:first-child{grid-column:1/-1}.candidate-toolbar button{align-self:end}.master-table-footer{display:grid;grid-template-columns:1fr;align-items:start}.candidate-pager{margin-top:8px}}
@media(max-width:900px){.page{width:min(100% - 20px,1200px);padding-top:10px}.executive-hero{padding:0}.hero-title-row{gap:12px}.hero-copy h1{font-size:36px;line-height:1}.hero-badges{gap:8px}.hero-badge{min-height:34px;padding:5px 11px}.hero-note{margin-top:7px}.hero-fact-card{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:0;min-height:0;padding:8px 14px}.hero-fact-card div{grid-template-columns:78px minmax(0,1fr);gap:8px;padding:4px 8px 4px 20px}.hero-fact-card::after{display:none}.pipeline-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.pipeline-card{grid-template-columns:44px minmax(0,1fr);min-height:72px;padding:9px 14px;border-right:1px solid var(--line);border-bottom:1px solid var(--line)}.pipeline-card:nth-child(2n){border-right:0}.pipeline-card:nth-last-child(-n+2){border-bottom:0}.pipeline-icon{width:40px;height:40px}.selection-flow-card{padding:9px 14px}.selection-flow{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px 12px}.flow-step{min-width:0}.flow-index{width:32px;height:32px;font-size:17px}.flow-step span:not(.flow-index){margin-top:5px}.flow-step strong{font-size:13px}.flow-step small{font-size:11px}.candidate-toolbar{grid-template-columns:1fr}.master-detail-header,.detail-table-heading,.preview-heading,.master-table-footer{display:block}.facts,.evidence li,.detail-grid{grid-template-columns:1fr}.detail-grid>span{border-right:0;border-bottom:1px solid var(--line)}.section{padding:14px}}
@media(max-width:640px){body{font-size:14px;line-height:1.5}.page{width:min(100% - 16px,1200px);padding:8px 0 16px}.hero-copy h1{font-size:32px;line-height:1.02}.hero-badges{gap:8px}.hero-badge{flex:1 1 calc(50% - 8px);justify-content:center;min-height:36px}.hero-note{align-items:flex-start}.hero-fact-card{padding:8px 10px}.hero-fact-card div{grid-template-columns:1fr;gap:2px;padding:5px 8px 5px 18px}.pipeline-card{min-height:70px;padding:9px 10px}.candidate-toolbar label{display:grid;gap:5px}.candidate-toolbar label span{white-space:normal}.candidate-toolbar input,.candidate-toolbar select,.candidate-toolbar button,.candidate-pager button,.candidate-pager select{min-height:44px}.candidate-cards[data-preview-table] th,.candidate-cards[data-preview-table] td{padding:8px}.candidate-master-detail{padding:8px}.master-table{max-height:58vh}.master-table table{min-width:860px}.candidate-detail-panel{box-shadow:none}.detail-head{gap:8px}.detail-head h3{font-size:19px}.detail-grid p,.detail-grid>span{padding:10px}.candidate-pager{display:grid;grid-template-columns:1fr 1fr;align-items:stretch}.candidate-page-numbers,.candidate-page-status,.candidate-pager label{grid-column:1/-1}.candidate-pager label{display:grid;gap:5px}.file-chip{display:block;width:100%;padding:8px 10px}.result-notice-card,.disclaimer-card{padding:14px 16px}.section{padding:12px}}
@media(max-width:520px){.hero-badge{flex-basis:100%}.hero-fact-card,.pipeline-metrics,.selection-flow{grid-template-columns:1fr}.pipeline-card{border-right:0}.pipeline-card:nth-last-child(2){border-bottom:1px solid var(--line)}.flow-step small{display:none}}
"""
JS = """
(() => {
