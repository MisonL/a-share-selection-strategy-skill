...
@media(max-width:520px){.hero-badge{flex-basis:100%}.hero-fact-card,.pipeline-metrics,.selection-flow{grid-template-columns:1fr}.pipeline-card{border-right:0}.pipeline-card:nth-last-child(2){border-bottom:1px solid var(--line)}.selection-flow{gap:10px}.flow-step small{display:none}}
"""
JS = """
(() => {
