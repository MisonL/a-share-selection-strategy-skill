...
TEXT = {
    ...
    "demo_report_title": {"en": "A-Share Selection Demo Report", "zh": "A 股选股 Demo 报告"},
    ...
    "pipeline_steps_hint": {"en": "Show command-level execution details", "zh": "查看命令级执行细节"},
    ...
    "consumes_prediction_columns": {"en": "Consumed prediction columns", "zh": "是否已消费预测列"},
    "prediction_input_source": {"en": "Prediction input source", "zh": "预测输入来源"},
    "requested_prediction_input_source": {"en": "Requested prediction input source", "zh": "请求的预测输入来源"},
    "prediction_model_executed_by_runner": {"en": "Prediction model executed by runner", "zh": "总控是否执行预测模型"},
    ...
    "history_failed_symbols": {"en": "History failed symbols", "zh": "历史取数失败标的"},
    "history_requested_end_date": {"en": "Requested history end date", "zh": "请求历史截止日"},
    "history_actual_date_max": {"en": "History actual latest date", "zh": "历史实际最新日期"},
    "history_end_date_has_rows": {"en": "History end date has rows", "zh": "截止日是否有行情行"},
    ...
    "limits": {"en": "What this report can and cannot prove", "zh": "这份报告能说明什么"},
