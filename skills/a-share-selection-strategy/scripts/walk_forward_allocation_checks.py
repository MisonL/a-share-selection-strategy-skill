...
def allocation_overlap_errors(allocation: dict[str, Any], overlap: dict[str, Any]) -> list[str]:
    errors = []
    for field in CAPACITY_FIELDS:
        allocation_value, allocation_error = capacity_value(allocation, field, "allocation")
...
def capacity_value(source: dict[str, Any], field: str, label: str) -> tuple[float | None, str | None]:
