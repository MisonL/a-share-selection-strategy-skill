...
class CliHelpWithoutDependenciesTests(unittest.TestCase):
    def test_core_navigation_help_does_not_import_pandas(self) -> None:
        cases = {
            ...
            "fetch_baostock_a_share.py": FETCH_CORE_OPTIONS
            | {
                "--drop-invalid-rows",
                "--names-input",
                "--missing-name-policy",
            ...
            "fetch_pytdx_a_share.py": FETCH_CORE_OPTIONS
            | {
                "--host",
                "--port",
                "--timeout-seconds",
            ...
            "execute_incremental_history_plan.py": {
                ...
                "--zzshare-max-concurrent-symbol-requests",
                "--zzshare-max-rate-limit-sleep-seconds",
                "--zzshare-max-429-events",
                "--zzshare-max-runtime-seconds",
                "--zzshare-progress-interval",
    ...
    def test_external_source_help_discloses_metadata_boundaries(self) -> None:
        cases = {
            ...
            "fetch_baostock_a_share.py": [
                "local CSV or Parquet and metadata",
