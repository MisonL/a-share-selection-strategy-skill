...
class TodayAShareDemoProvenanceTests(unittest.TestCase):
    def test_create_demo_data_writes_demo_metadata(self) -> None:
        ...
        self.assertEqual("spot.csv", metadata["spot"])
    ...
    def test_today_runner_reports_synthetic_demo_metadata(self) -> None:
        ...
        self.assertEqual("synthetic_demo", summary["source_provenance"]["source_type"])
        self.assertEqual("local_prices_input", summary["source_provenance"]["source_scope"])
        self.assertEqual(False, summary["source_provenance"]["real_market_data"])
